...
Partial Public NotInheritable Class AtchMgr
...
Partial Friend NotInheritable Class Globals
    ...
    Private Shared _AtchMgr As AtchMgr
    ...
    Friend Shared Property AtchMgr() As AtchMgr
        Get
            Return _AtchMgr
        End Get
        Set(value As AtchMgr)
            If (_AtchMgr Is Nothing) Then
                _AtchMgr = value
            Else
    ...
    Friend Shared ReadOnly Property FormRegions() As ThisFormRegionCollection
        Get
            If (_ThisFormRegionCollection Is Nothing) Then
                _ThisFormRegionCollection = New ThisFormRegionCollection(Globals.AtchMgr.GetFormRegions)
            End If
...
Partial Friend NotInheritable Class ThisFormRegionCollection
    ...
    Default Friend Overloads ReadOnly Property Item(ByVal explorer As Microsoft.Office.Interop.Outlook.Explorer) As WindowFormRegionCollection
        Get
            Return CType(Globals.AtchMgr.GetFormRegions(explorer, GetType(WindowFormRegionCollection)), WindowFormRegionCollection)
        End Get
    End Property
    ...
    Default Friend Overloads ReadOnly Property Item(ByVal inspector As Microsoft.Office.Interop.Outlook.Inspector) As WindowFormRegionCollection
        Get
            Return CType(Globals.AtchMgr.GetFormRegions(inspector, GetType(WindowFormRegionCollection)), WindowFormRegionCollection)
        End Get
    End Property
End Class
